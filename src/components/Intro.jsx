...
function Intro() {
  ...
  return (
    <div className="intro flex flex-col justify-evenly justify-items-center items-center content-center self-center bg-black">
        ...
        {/* Greeting */}
        <div className="presentation-container flex flex-col justify-evenly justify-items-center items-center content-center self-center w-5/6 sm:w-3/6">
          <div className="presentation-container-greeting">
            <h2 className="hidden md:block text-2xl sm:text-4xl xlg:text-5xl xl:text-6xl font-semibold font-mono">&#123;Hello, world!&#125;</h2>
            <h2 className="md:hidden text-3xl sm:text-4xl xlg:text-5xl xl:text-6xl font-semibold font-mono">&#123;"Welcome!"&#125;</h2>
          </div>

          <div className="presentation-container-name my-6">
            <h1 className="hidden md:block text-xl sm:text-2xl xl:text-4xl">My name is{" "}<span className="text-red-700 font-bold">Pelayo Trives</span></h1>
            <h1 className="md:hidden text-xl sm:text-2xl xl:text-4xl">I'm{" "}<span className="text-red-700 font-bold">Pelayo Trives</span></h1>
          </div>
