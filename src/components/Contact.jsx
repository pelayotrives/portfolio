...
function Contact() {
  ...
  return (
    <div id='contact' className='contact flex flex-col justify-center justify-items-center content-center items-center self-center bg-zinc-800'>
      ...
      <div className="presentation-container-greeting flex flex-col justify-center justify-items-center content-center items-center self-center w-3/6">
        <h2 className="text-6xl font-bold my-6">Contact</h2>
      </div>

      <div className="skills-content w-3/6">
        <p className="text-justify">You can contact me by <span className='font-bold text-red-700'>phone</span> or by <span className='font-bold text-red-700'>email</span>. Click on any of the two icons to open a <span className='font-bold text-red-700'>new window</span> and take the first step of something very important! If you want to know more details about me, fill out the following form.</p>
      </div>

      <div className='icon-wrapper flex flex-row justify-center justify-items-center content-center items-center self-center w-3/6 my-6'>
      ...
      <form ref={formRef} onSubmit={handleSubmit} className='flex flex-col w-3/6'>
