                ...
                <div className="about-left-text flex flex-col justify-center justify-items-center content-center items-center self-center">
                    ...
                    <div className="about-left-title self-start">
                        <div className="about-left-title-wrapper">
                            ...
                            <br />
                            <h2 className='about-left-title-item text-7xl font-bold'>...and more <span className='text-responsive'>stuff.</span></h2>
                            <br />
                        </div>
                    </div>

                    <div className="about-left-content">
                        <p className='text-lg text-top-content text-content-descriptive mt-14'>Programming has always been my passion. I started with <span className='font-bold'>PHP</span> during my university studies while improving my <span className='font-bold text-red-700'>digital marketing</span>, <span className='font-bold text-red-700'>design</span> and <span className='font-bold text-red-700'>UX/UI design</span> skills. <span className='text-responsive'> Little by little, I gained confidence and attended Ironhack's web development bootcamp, where my vision of programming changed and my skills improved a lot.</span></p>
                        <p className='text-mid-content text-lg text-content-descriptive mt-7'>I became fluent in <span className='font-bold text-red-700'>MERN Stack</span> as well as <span className='font-bold text-red-700'>semantic HTML, CSS</span> and other tools like <span className='font-bold text-red-700'>WordPress</span>. I have found in <span className='font-bold text-red-700'>JavaScript</span> my ideal partner, and every day I try to improve little by little.</p>
                        <p className='text-lg text-bottom-content text-content-descriptive mt-7 text-responsive'>Do you want to see how?</p>
                    </div>

                    <div className='video-responsive justify-center justify-items-center content-center items-center self-center w-1/2'>
                        <video className='video-responsive-measures' preload controls>
